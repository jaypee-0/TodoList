  ...
  return (
    <div id='App' className='container'>
      ...
      <div className='col-11 col-md-7 m-auto'>
        ...
        <hr className='mt-0' />
        {showinput && (
          <form className='d-flex mb-2 w-100' onSubmit={handleSubmit}>
            <input
            ...
            />
            <button className='py-2 px-4 add'>Add</button>
          </form>
        )}
        {/* Todolists */}
          ...
          {showall && (
            <div className='d-flex flex-column'>
              {TODO.map((todo) => {
                return (
                  <ul
                    className='carding list d-flex flex-row mb-3 pl-0 align-items-center justify-content-between'
                    key={todo.id}>
                    <input
                      type='checkbox'
                    ...
                    <li
                      className={
                        todo.completed
                          ? 'text-decoration-line-through me-auto'
                          : 'me-auto'
                      }>
                      {todo.task}
                    </li>
                    <button
                      ...
                      className='del py-0'>
                      <FA icon='fa-trash-can' beatFade='true' />
                    </button>
                  </ul>
                );
              })}
          ...
          {completedbar && (
            <div>
              ...
              <div className='d-flex flex-row align-items-center mt-2'>
                <button
                  className='genDel ms-auto px-3 py-2'
